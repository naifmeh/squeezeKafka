...
public class VideoFrameCapture implements Runnable {
    private static final Logger logger = LoggerFactory.getLogger(VideoFrameCapture.class.getSimpleName());
    ...
    public VideoFrameCapture(String cameraid, String url, KafkaProducer<String,String> producer, String topic) {
